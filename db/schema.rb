...
ActiveRecord::Schema.define(version: 20150310040637) do
  ...
  add_index "responses", ["answer_id", "user_id"], name: "index_responses_on_answer_id_and_user_id", unique: true, using: :btree
